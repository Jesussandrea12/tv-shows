...
(0, _jquery2.default)(function () {
  ...
  $tvShowsContainer.on('click', 'div.like', function (ev) {
    var $this = (0, _jquery2.default)(this);
    $this.closest('div#like.like').toggleClass('is-liked');
  });
  ...
  var template = '<article class="tv-show">' + '<div class="left img-container">' + '<img src=":img:" alt=":img alt:">' + '</div>' + '<div class="right info">' + '<h1>:name:</h1>' + '<p>:summary:</p>' + '<div class="like" id="like"></div>';
  '</div>' + '</article>';
